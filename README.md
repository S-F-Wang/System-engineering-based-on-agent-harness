...
The first seven cumulative Chapters now establish the model, Runtime, Tool, Session-control, persistence, context-management, and Extension seams:
...
- [`course/checkpoints/ch07/`](course/checkpoints/ch07/) is the latest generated cumulative Checkpoint Package.
...
PYTHONPATH=course/checkpoints/ch07/src \
  uv run python -m pytest -p no:cacheprovider course/checkpoints/ch07/tests
```
