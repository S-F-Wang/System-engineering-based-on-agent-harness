...
The first three cumulative Chapters now establish the model, Runtime, and Tool seams:
...
- [`course/checkpoints/ch03/`](course/checkpoints/ch03/) is the latest generated cumulative Checkpoint Package.
...
PYTHONPATH=course/checkpoints/ch03/src \
  uv run python -m pytest -p no:cacheprovider course/checkpoints/ch03/tests
```
