...
The first four cumulative Chapters now establish the model, Runtime, Tool, and Session-control seams:
...
- [`course/checkpoints/ch04/`](course/checkpoints/ch04/) is the latest generated cumulative Checkpoint Package.
...
PYTHONPATH=course/checkpoints/ch04/src \
  uv run python -m pytest -p no:cacheprovider course/checkpoints/ch04/tests
```
