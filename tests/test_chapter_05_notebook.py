...
CHAPTER = ROOT / "course" / "notebooks" / "05_durable_sessions.ipynb"
CHECKPOINT = ROOT / "course" / "checkpoints" / "ch05"


def test_chapter_05_is_structured_and_runs_in_a_clean_kernel() -> None:
...
def test_chapter_05_checkpoint_has_no_export_drift() -> None:
