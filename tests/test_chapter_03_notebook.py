...
CHAPTER = ROOT / "course" / "notebooks" / "03_structured_tools.ipynb"
CHECKPOINT = ROOT / "course" / "checkpoints" / "ch03"


def test_chapter_03_is_structured_and_runs_in_a_clean_kernel() -> None:
...
def test_chapter_03_checkpoint_has_no_export_drift() -> None:
