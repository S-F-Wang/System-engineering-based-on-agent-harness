...
CHAPTER = ROOT / "course" / "notebooks" / "04_run_control.ipynb"
CHECKPOINT = ROOT / "course" / "checkpoints" / "ch04"


def test_chapter_04_is_structured_and_runs_in_a_clean_kernel() -> None:
...
def test_chapter_04_checkpoint_has_no_export_drift() -> None:
