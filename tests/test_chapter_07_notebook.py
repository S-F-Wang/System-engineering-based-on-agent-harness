...
CHAPTER = ROOT / "course" / "notebooks" / "07_extensions.ipynb"
CHECKPOINT = ROOT / "course" / "checkpoints" / "ch07"


def test_chapter_07_is_structured_and_runs_in_a_clean_kernel() -> None:
...
def test_chapter_07_checkpoint_has_no_export_drift() -> None:
