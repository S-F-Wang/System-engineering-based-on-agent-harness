...
CHAPTER = ROOT / "course" / "notebooks" / "06_context_compaction.ipynb"
CHECKPOINT = ROOT / "course" / "checkpoints" / "ch06"


def test_chapter_06_is_structured_and_runs_in_a_clean_kernel() -> None:
...
def test_chapter_06_checkpoint_has_no_export_drift() -> None:
