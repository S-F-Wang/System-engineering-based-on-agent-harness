...
CHAPTER = ROOT / "course" / "notebooks" / "02_async_runtime.ipynb"
CHECKPOINT = ROOT / "course" / "checkpoints" / "ch02"


def test_chapter_02_is_structured_and_runs_in_a_clean_kernel() -> None:
...
def test_chapter_02_checkpoint_has_no_export_drift() -> None:
