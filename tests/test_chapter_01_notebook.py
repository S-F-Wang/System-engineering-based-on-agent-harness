...
CHAPTER = ROOT / "course" / "notebooks" / "01_model_boundary.ipynb"
CHECKPOINT = ROOT / "course" / "checkpoints" / "ch01"


def test_chapter_01_is_structured_and_runs_in_a_clean_kernel() -> None:
...
def test_chapter_01_checkpoint_has_no_export_drift() -> None:
